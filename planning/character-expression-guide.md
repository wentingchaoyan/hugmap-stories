...
- 先生たちは子どもが大好きである。
- 子どもの「好き」「得意」「育っている」を次々に見つける。
- 子どもの可能性を大きく信じている。
- 先生同士も関わることが好きで、一つのチームとして動く。
- 全員で一緒に過ごすときもあれば、それぞれの安心空間で過ごすときもある。
- 閉じた施設より、開放的で未来を感じられる場所が合う。
- 楽しいことや、一見どうでもよいことから遊びを始められる。
- 共感するだけで終わらず、各自の知識から解釈と助言を行う。
- ポジティブで未来志向だが、悲しみや難しさを急いで消さない。
...
- みんなで集まる開放的な場所。
- 一人で安心して過ごせる小さな場所。
- 描く、並べる、予定を見えるようにする場所。
- 食べ物へゆっくり関われる場所。
- 気づきや思い出を保管し、次の人へ渡す場所。
...
- 動物たちは、子どもと保護者の双方に普通に見えるのか。
- 動物たちは、どこに住み、どのように日常へ出かけるのか。
- 先生同士の呼び方と、子ども・保護者からの呼び方。
- ぽけっとさんの種族、姿、チーム内の立場。
- 各先生の弱点や失敗が、チームによってどう補われるか。
- 各先生の安心空間と、全員が集まる共通空間。
- キャラクターの仕草や道具を、公式イラストへどう反映するか。
