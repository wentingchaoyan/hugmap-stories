...
ぽけっとさんは動物ではなく、**ポケットそのものが動く小さな記録係**とする。カンガルー案は使用しない。基本形は `#FF511B` の角丸ポケットと白い記録カードで、左目は白い「○」、右目は白い「<」。口・鼻・耳・尻尾・常設の手は加えず、開口部を口として扱わない。小表示ではMaterial Design的なフラットアイコン、大きな絵本画面では同じ輪郭を保った柔らかな面表現へ展開する。
...
- 大切な言葉を聞くと、上の開口部が少し広がり、白い記録カードを受け取る。
- 写真やカードを日付順に並べる。
...
- 移動するときは底の左右が交互に縮み、短いすり足で一歩ずつ進む。手足は描き足さない。
- 表情は「○」と「<」の向き、身体全体の傾き、カードの出入りだけで示す。
...
| 先生 | 基本形 | 見つけ方 | 関わり方 |
|---|---|---|---|
| Mimo（ことり先生） | 身体と縦長の卵形頭部を少し傾け、静かに聴く | 子どもの小さな声・視線・仕草へ顔と片翼を寄せる | 同じ仕草を小さく返し、羽を閉じて返事を待つ |
| Luke（りす先生） | 柔らかい縦長頭部、三本の額毛、大きな尻尾を保って立つ | 手がかりへ顔と片手が先に動き、必要な素材を選ぶ | 二つの素材を手のひらへ置き、本人が選ぶのを待つ |
| Gen（うさぎ先生） | 低い頬と左右非対称の耳を保ち、前へ出る準備をする | 一歩前へ出た後、相手の反応へ気づいて身体を低くする | 同じ高さから片手を開き、一緒の小さな一歩を誘う |
...
![メイン3人の記号型ポーズ比較](style-studies/outputs/groups/01-main-three-symbolic-pose-sheet-v1.png)

**キャラクター・アニメーション型の試作**

丸い量感、分かりやすい感情、大きなジェスチャーで構成する。役割の即時性と、スタンプや動画へ展開したときの動かしやすさを検証する。

![メイン3人のキャラクター・アニメーション型ポーズ比較](style-studies/outputs/groups/02-main-three-animated-pose-sheet-v1.png)

**コラージュ・素材型の試作**

手で塗った薄紙、ちぎった輪郭、色面の重なり、紙の余白で構成する。身体性と絵本らしい温度が出る一方、縮小時には紙の繊維や細い道具が見えにくくなる。

![メイン3人のコラージュ・素材型ポーズ比較](style-studies/outputs/groups/03-main-three-collage-pose-sheet-v1.png)

#### 用途別の使い分け

| 用途 | 基本にする表現 | 理由 |
|---|---|---|
| 小さいアイコン | 透明背景、フラット色、外輪郭を弱めた記号型 | 頭部記号、目・鼻・口、代表ポーズを優先し、影は重なり部分だけに限定する |
