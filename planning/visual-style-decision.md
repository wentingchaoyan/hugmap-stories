...
| 問い | 候補A | 候補B |
|---|---|---|
| 読者は子どもの内側を想像できるか | **強い** | 動物の反応が答えを先に示す場合がある |
| 動物の個性が一目で分かるか | 形と持ち物で分かる | **形、表情、動きで強く分かる** |
| 先生が子どもの主役性を奪わないか | **抑えやすい** | 動物の彩度とジェスチャーを抑える必要がある |
| 小さい画面で使えるか | **強い** | 表情の細部を減らす必要がある |
| シリーズの楽しさを出せるか | 静かで温かい | **明るく活発** |

## 6. 現時点の推奨

基本案は、**候補A「線画の人物＋記号型の動物」**とする。

ただし動物を完全な無表情にはせず、候補Bから次の要素だけを取り入れる。
...
これは曖昧な折衷ではない。**形は候補A、動きの設計だけ候補B**という役割分担である。

## 7. 最終判断のために作る2枚

次は同一場面を、候補Aと候補Bで一枚ずつ作る。
